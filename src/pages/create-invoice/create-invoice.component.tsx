...
const defaultInvoiceItem: InvoiceItemType = {
    ...
    discount_percent: 0,
    extras: {
        session_expires_on: moment().format("Y-MM-DD"),
    }
};
                            ...
                            <Form>
                                <div className={'create-invoice__cont'}>
                                    ...
                                    <CreateInvoiceSection title={'Set the Invoice Details'}>
                                        <FormRow>
                                            <FormDatepicker label={'Issuance Date'} name={'invoice.issuance_date'}
                                                            disabledDate={date => date.isBefore(moment().startOf("day"))}/>
                                            <FormDatepicker label={'Due Date'} name={'invoice.due_date'}
                                                            disabledDate={date => date.isBefore(moment().startOf("day"))}/>
