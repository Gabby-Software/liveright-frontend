...
import FormInputLabeled, {
  FormInputLabeledUI
} from '../../../../components/forms/form-input-labeled/form-input-labeled.component'
  ...
  return (
    <Styles>
        ...
        <div className={'ci-item__left'}>
          ...
          {item.type === 'PT session' ? (
            <p className={'ci-item__credits'}>
              Total Sessions After Invoice: {credits}
            </p>
          ) : null}
        </div>
      ...
      {form.values.items.length > 1 ? (
        <div className={'ci-item__remove'} onClick={() => helper.remove(i)}>
          Remove
        </div>
      ) : null}
    </Styles>
