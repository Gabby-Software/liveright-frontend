...
import {invoiceDiscount, invoiceTax, invoiceTotal} from "../../../../pipes/invoice-total.pipe";
...
const CreateInvoiceSummary: FC<Props> = ({items}) => {
    ...
    return (
        <Styles>
            ...
            <SummaryItem label={t('invoices:discount')} value={asMoney(asPrice(invoiceDiscount(items)))}/>
            <SummaryItem label={t('invoices:vat')} value={asMoney(asPrice(invoiceTax(items)))}/>
            <Hr/>
            <SummaryItem label={t('invoices:total')} value={asMoney(asPrice(invoiceTotal(items)))}/>
        </Styles>
    )
};
