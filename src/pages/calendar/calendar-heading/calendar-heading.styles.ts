...
export default styled.div`
  ...
  .calendar-heading {
    ...
    &__icon {
      ...
      &:first-child {
        border-radius: ${(p) => p.theme.vars.sizes.borderRadius} 0 0
          ${(p) => p.theme.vars.sizes.borderRadius};
      }
      &:last-child {
        border-radius: 0 ${(p) => p.theme.vars.sizes.borderRadius}
          ${(p) => p.theme.vars.sizes.borderRadius} 0;
      }
      &:hover {
