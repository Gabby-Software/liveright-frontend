/* eslint-disable no-unused-vars,jsx-a11y/click-events-have-key-events,react/jsx-key,jsx-a11y/no-static-element-interactions,@typescript-eslint/no-unused-vars,@typescript-eslint/no-empty-function,react/prop-types */
    ...
    <Styles>
      <div className={'sessions'}>
        ...
        <div className="sessions__progress">
          ...
          <SessionProgressItem
            label={t('sessions:consultation')}
            target={15}
            current={5}
          />
          <SessionProgressItem
            label={t('sessions:ptSession')}
            target={20}
            current={6}
          />
