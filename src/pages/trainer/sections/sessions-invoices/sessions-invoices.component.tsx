        ...
        <Styles>
            <Link to={Routes.INVOICES}>
                <Card className={'stats__item'}>
                    ...
                    <div className={'stats__desc'}>{t('profile:open-invoices', {x: 0})}</div>
            ...
            <Link to={Routes.SESSIONS}>
                <Card className={'stats__item'}>
                    ...
                    <div className={'stats__desc'}>{t('profile:free-sessions', {x: 0})}</div>
                    <div className={'stats__desc'}>{t('profile:upcoming-sessions', {x: 0})}</div>
                </Card>
            </Link>
