...
import AddSessionMobile
  from "../../../pages/sessions/sections/add-session/add-session-mobile/add-session-mobile.component";
...
const MobileSessionFooter = () => {
    ...
    return (
        <>
            ...
            <AddSessionMobile isOpen={isFormOpen} onClose={() => setIsFormOpen(false)}/>
